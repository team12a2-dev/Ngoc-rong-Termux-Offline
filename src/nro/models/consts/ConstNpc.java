...
public class ConstNpc {
    ...
    public static final int CON_SO_MAY_MAN = 504;
    public static final int CON_SO_MAY_MAN_GEM_MUC_CUOC = 510;
    public static final int CON_SO_MAY_MAN_VANG_MUC_CUOC = 511;
    ...
    public static final int KOL_MISSION_SUB_MENU = 1015;
