            ...
            try {
                ...
                if (player.isDie()) {
                    ...
                    if (MapService.gI().isMapMaBu(mapId)) {
                        ...
                        x = 300;
                        y = 336;
                    } else if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapBlackBallWar(mapId) || ChangeMapService.gI().checkMapCanJoin(player, MapService.gI().getMapCanJoin(player, mapId, 0)) == null) {
                        mapId = player.gender + 21;
                        x = 300;
                        y = 336;
                    }
                ...
                //data nội tại
                if (player.playerIntrinsic != null && player.playerIntrinsic.intrinsic != null) {
                ...
                dataArray.add(player.playerIntrinsic != null ? player.playerIntrinsic.countOpen : 0);
