...
public class DeathOrAliveArena {
    ...
    private void traThuongHatMit(boolean playerWin) {
        try {
            long tongCuoc = (cuocBaHatMit + cuocPlayer) * 900000;
    ...
    @java.lang.SuppressWarnings("all")
    public void setTimeTotal(final long timeTotal) {
    ...
    @java.lang.SuppressWarnings("all")
    public void setCuocBaHatMit(final int cuocBaHatMit) {
        this.cuocBaHatMit = cuocBaHatMit;
    }

    @java.lang.SuppressWarnings("all")
    public int getCuocBaHatMit() {
        return this.cuocBaHatMit;
    }

    @java.lang.SuppressWarnings("all")
    public void setCuocPlayer(final int cuocPlayer) {
        this.cuocPlayer = cuocPlayer;
    }

    @java.lang.SuppressWarnings("all")
    public int getCuocPlayer() {
        return this.cuocPlayer;
    }
