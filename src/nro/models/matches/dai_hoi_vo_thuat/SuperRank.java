...
public final class SuperRank implements Runnable {
    ...
    private void handleMatchStart() {
        switch (timeUp++) {
            ...
            case 2 -> Service.gI().chat(rival, ConstSuperRank.TEXT_SAN_SANG_CHUA);
            case 3 -> {
            ...
            case 4 -> rival.changeStatus(BossStatus.ACTIVE);
        }
    }

    private boolean isPlayerAliveInZone() {
        return player != null && player.isPKDHVT && !player.lostByDeath && player.location != null && !player.isDie() && player.zone != null && player.zone.equals(zone);
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setRival(final Boss rival) {
        this.rival = rival;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setRivalId(final long rivalId) {
        this.rivalId = rivalId;
    }

    @java.lang.SuppressWarnings("all")
    public void setCompeting(final boolean isCompeting) {
    ...
    @java.lang.SuppressWarnings("all")
    public void setTimeUp(final int timeUp) {
        this.timeUp = timeUp;
    }

    @java.lang.SuppressWarnings("all")
    public void setTimeDown(final int timeDown) {
    ...
    @java.lang.SuppressWarnings("all")
    public void setRankWin(final int rankWin) {
        this.rankWin = rankWin;
    }

    @java.lang.SuppressWarnings("all")
    public void setRankLose(final int rankLose) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof SuperRank)) return false;
        final SuperRank other = (SuperRank) o;
        if (this.getPlayerId() != other.getPlayerId()) return false;
        if (this.getRivalId() != other.getRivalId()) return false;
        if (this.isCompeting() != other.isCompeting()) return false;
        if (this.isWin() != other.isWin()) return false;
        if (this.getTimeUp() != other.getTimeUp()) return false;
        if (this.getTimeDown() != other.getTimeDown()) return false;
        if (this.getError() != other.getError()) return false;
        if (this.getRankWin() != other.getRankWin()) return false;
        if (this.getRankLose() != other.getRankLose()) return false;
        ...
        final java.lang.Object this$rival = this.getRival();
        final java.lang.Object other$rival = other.getRival();
        if (this$rival == null ? other$rival != null : !this$rival.equals(other$rival)) return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        final long $rivalId = this.getRivalId();
        result = result * PRIME + (int) ($rivalId >>> 32 ^ $rivalId);
        result = result * PRIME + (this.isCompeting() ? 79 : 97);
        result = result * PRIME + (this.isWin() ? 79 : 97);
        result = result * PRIME + this.getTimeUp();
        result = result * PRIME + this.getTimeDown();
        result = result * PRIME + this.getError();
        result = result * PRIME + this.getRankWin();
        result = result * PRIME + this.getRankLose();
        ...
        final java.lang.Object $rival = this.getRival();
        result = result * PRIME + ($rival == null ? 43 : $rival.hashCode());
        return result;
    }
    ...
    public java.lang.String toString() {
        return "SuperRank(zone=" + this.getZone() + ", player=" + this.getPlayer() + ", rival=" + this.getRival() + ", playerId=" + this.getPlayerId() + ", rivalId=" + this.getRivalId() + ", isCompeting=" + this.isCompeting() + ", win=" + this.isWin() + ", timeUp=" + this.getTimeUp() + ", timeDown=" + this.getTimeDown() + ", error=" + this.getError() + ", rankWin=" + this.getRankWin() + ", rankLose=" + this.getRankLose() + ")";
    }
}
