...
public class Bill extends Npc {
    ...
    public void openBaseMenu(Player player) {
        ...
        if (mapId == 154) {
            ...
            createOtherMenu(player, ConstNpc.BASE_MENU,
                    "Hê sờ lô, hê sờ ly\nMặc full Set Thần Linh + x99 Thức ăn bên Cold, Ta sẽ bán đồ Hủy Diệt\nThức ăn còn lại, ta sẽ giúp ngươi đổi vật phẩm VIP",
                    "Nói\nchuyện",
                    "Hướng\ndẫn\nthêm",
                    "Đổi thức ăn\nlấy phiếu ăn",
                    "Đổi phiếu ăn\nlấy quà",
                ...
                switch (player.idMark.getIndexMenu()) {
                    ...
                    case ConstNpc.BASE_MENU -> {
                        switch (select) {
                            ...
                            case 2 -> { // Đổi thức ăn -> phiếu ăn
                                createOtherMenu(player, 10,
                                        "Ngươi có muốn đổi thức ăn thành phiếu ăn nhanh không\nX99 thức ăn bất kỳ sẽ nhận được 1 phiếu?",
                                        "Đồng ý", "Từ chối");
    ...
    private void doiNhanhItem(Player player) {
        ...
        if (total1805 > 0) {
            ...
            Service.gI().sendThongBao(player,
                    "Bạn đã đổi thành công " + total1805 + " x Phiếu ăn.");
        } else {
            Service.gI().sendThongBao(player,
                    "Bạn không có đủ 99 phần của bất kỳ vật phẩm nào để đổi.");
        }
    }
}
