...
public class QuyLaoKame extends Npc {
    ...
    public void confirmMenu(Player player, int select) {
        ...
        switch (player.idMark.getIndexMenu()) {
            ...
            case ConstNpc.KOL_VIP_REWARD_MENU:
                ...
                break;
            case ConstNpc.KOL_MISSION_SUB_MENU:
                handleKOLMissionSubMenu(player, select);
                break;
        }
    }
    ...
    private void handleBaseMenu(Player player, int select) {
        switch (select) {
            ...
            case 1:
                ...
                break;
            case 2:
                openKOLMissionMenu(player);
                break;
            case 3:
                ClanService.gI().recheckClan(player);
                break;
            case 4:
    ...
    private void openKOLMissionMenu(Player player) {
        this.createOtherMenu(player, ConstNpc.KOL_MISSION_SUB_MENU,
                "Chọn nhiệm vụ KOL con muốn làm nào?",
                "Nhận quà\nKOL", "Nhận quà\nKOL VIP", "Đóng");
    }

    private void handleKOLMissionSubMenu(Player player, int select) {
        switch (select) {
            case 0:
