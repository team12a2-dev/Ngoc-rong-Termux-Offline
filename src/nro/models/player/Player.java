...
//                }
   ...
   public synchronized int injured(Player plAtt, long damage, boolean piercing, boolean isMobAttack) {
      System.out.println("[DEBUG] Player.injured: target=" + this.name + ", plAtt=" + (plAtt != null ? plAtt.name : "null") + ", damage=" + damage + ", currentHp=" + this.nPoint.hp + ", isMobAttack=" + isMobAttack);
      if (!this.isDie()) {
