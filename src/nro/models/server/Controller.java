...
public class Controller implements IMessageHandler {
        ...
        try {
            ...
            switch (cmd) {
                ...
                case -74: {
                    ...
                    Logger.warning("Địa chỉ " + mySession.ipAddress + " đang tải dữ liệu\n");
                    DataGame.handleDownloadPacket(mySession, _msg);
                    break;
                }
                case -81:
                    if (player != null) {
                ...
                case 44:
                    if (player != null) {
                        ...
                        if (DataDownloadService.gI().isDownloadCommand(chatText)) {
                            DataDownloadService.gI().handleChatCommand(player, chatText);
                        } else {
                            Command.gI().chat(player, chatText);
                        }
                    }
                    break;
                case 32:
                ...
                switch (cmd) {
                    ...
                    case 13:
                        ...
                        if (player != null && player.isPl()) {
                            ...
                            Service.gI().clearMabuWait(_session);
    ...
    public void sendInfo(MySession session) {
        try {
            ...
            Service.gI().clearMabuWait(session);
