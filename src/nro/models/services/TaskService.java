...
public void checkDoneTaskUseItem(Player player, Item item) {
  ...
  npcSay(player, ConstNpc.BO_MONG,
    ...
    public boolean isCurrentTaskTauPayPayQuest(Player player) {
    ...
    private boolean doneTaskDeliverTauPayPayDragonBall(Player player) {
        ...
        if (!InventoryService.gI().isExistItemBag(player, ConstItem.NGOC_RONG_6_SAO)) {
            return false;
        }
        try {
            InventoryService.gI().subQuantityItemsBag(player,
                    InventoryService.gI().findItemBag(player, ConstItem.NGOC_RONG_6_SAO), 1);
    ...
    public boolean hasCompletedTauPayPayQuest(Player player) {
        ...
        return player.playerTask.taskMain.id > 9 || getIdTask(player) >= ConstTask.TASK_10_0;
    }
        ...
        if (player.playerTask.sideTask.isDone()) {
            ...
            if (InventoryService.gI().getCountEmptyBag(player) > 0) {
                ...
                Service.gI().sendThongBao(player,
                        ...
                        + quantity + " " + ngocXanh.template.name);
