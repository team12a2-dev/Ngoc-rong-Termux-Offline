...
public class Shenron_Event {
    ...
    public static final String[] SHENRON_WISHES = new String[] {"Điều ước 1", "Điều ước 2", "Điều ước 3", "Điều ước 4"};
        ...
        try {
            if (!shenronLeave) {
                if (isPlayerDisconnect) {
                    ...
                    if (pl != null) {
                        player = pl;
                        if (player.zone != null && player.zone.map.mapId != 0 && player.zone.map.mapId != 7 && player.zone.map.mapId != 14 && player.zone.map.mapId != 21 && player.zone.map.mapId != 22 && player.zone.map.mapId != 23) {
        ...
        case 0: 
            ...
            case 2: 
                if (InventoryService.gI().getCountEmptyBag(player) > 0) {
                    ...
                    Item avtVip = ItemService.gI().createNewItem((short) (gender == ConstPlayer.TRAI_DAT ? 905 : gender == ConstPlayer.NAMEC ? 907 : 911));
            ...
            case 3: 
                if (InventoryService.gI().getCountEmptyBag(player) > 0) {
                    byte gender = this.player.gender;
                    Item avtVip = ItemService.gI().createNewItem((short) (gender == ConstPlayer.TRAI_DAT ? 883 : gender == ConstPlayer.NAMEC ? 883 : 883));
